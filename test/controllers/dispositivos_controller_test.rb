...
class DispositivosControllerTest < ActionController::TestCase
  ...
  test "should create dispositivo" do
    assert_difference('Dispositivo.count') do
      post :create, dispositivo: { activo: @dispositivo.activo, codigo: @dispositivo.codigo, descripcion: @dispositivo.descripcion }
    end
  ...
  test "should update dispositivo" do
    patch :update, id: @dispositivo, dispositivo: { activo: @dispositivo.activo, codigo: @dispositivo.codigo, descripcion: @dispositivo.descripcion }
    assert_redirected_to dispositivo_path(assigns(:dispositivo))
  end
